...
def parse_args():
    ...
    parser.add_argument("--api_key", type=str, help="GPT_API_KEY")
    parser.add_argument("--number of datasets", type=int, help="dataset count")

    parser.add_argument("--persona_path", type=str, help="persona_path")
    parser.add_argument("--relationship_path", type=str, help="relationship_path")
